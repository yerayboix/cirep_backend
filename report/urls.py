...
urlpatterns = [
    ...
    path('get_nearby_reports/', IncidenciaViewSet.as_view({'post': 'get_nearby_reports'}), name='get-nearby-reports'),
    path('get_reports_by_state/', IncidenciaViewSet.as_view({'post': 'get_reports_by_state'}), name='get-reports-by-state'),
